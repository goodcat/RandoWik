...
public class DbHelper {
	...
	public static final String PAGES_COLUMN_PAGE_ID = "page_id";
	...
	public void savePage(Date date, String pageId, String pageTitle,
			String pageContent) {
		if (date == null)
			date = new Date();
		ContentValues contentValues = new ContentValues();
		contentValues.put(PAGES_COLUMN_PAGE_ID, pageId);
	...
	public Cursor findPageByPageId(String pageId) {
		return database.rawQuery("SELECT * FROM "+TABLE_NAME + " WHERE " + PAGES_COLUMN_PAGE_ID + " = ?", new String[]{pageId});
	}
	...
	private class RandoWikOpenHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			String sql = "CREATE TABLE " + TABLE_NAME + " (" + 
					PAGES_COLUMN_ID + " INTEGER PRIMARY KEY, " + 
					PAGES_COLUMN_PAGE_DATETIME + " TEXT, " + 
					PAGES_COLUMN_PAGE_ID + " TEXT, " + 
